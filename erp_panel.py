...
def init_db():
    with conn.session as s:
        tablolar = [
            ...
            """CREATE TABLE IF NOT EXISTS bildirimler (id SERIAL PRIMARY KEY, tip TEXT, mesaj TEXT, hedef_rol TEXT DEFAULT 'Tumu', okundu BOOLEAN DEFAULT false, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)""",
...
with st.sidebar:
    ...
    notif_df = load_df("SELECT COUNT(*) as n FROM bildirimler WHERE okundu=false")
